...
import "fmt"
```
`import` ottaa käyttöön kirjaston. [fmt](https://golang.org/pkg/fmt/) vaaditaan, koska ohjelma käyttää siinä määriteltyä funktiota [Println](https://golang.org/pkg/fmt/#Println).
